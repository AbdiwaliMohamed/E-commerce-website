...
<head>
	...
	<title>Admin| Insert Product in Adeege Store</title>
...
<div class="control-group">
<label class="control-label" style="background-color: lightblue" for="basicinput">Sub Category</label>
<div class="controls" style="background-color: lightblue">
...
<div class="control-group" style="background-color: lightblue">
