...
<div class="control-group">
<label class="control-label" style="background-color: lightblue" for="basicinput">Product Name</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label"  style="background-color: lightblue" for="basicinput">Product Company</label>
<div class="controls">
