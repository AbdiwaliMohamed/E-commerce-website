...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="img/adeegelogo.jpg" style="width: 160px;height: 80px">
	</head>
    <body class="cnt-home">
...
{
    ?>
		<div class="accordion" style="background-color: orange">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category.php?cid=<?php echo htmlentities($row['id']);?>"  class="accordion-toggle collapsed" style="background-color: lightblue">
