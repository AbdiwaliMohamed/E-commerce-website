...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="img/logo%20mb1234.png">
                    ...
                    <div class="table-responsive">
                        <form name="cart" method="post">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                <tr style="color: white;background-color: #0c3a83">
								...
								<span class="">
								<a style="background-color: green" href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continue Shopping</a>
								<input style="background-color: #0c3a83" type="submit" name="submit" value="Refresh" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
//print_r($_SESSION['pid'])=$pdtid;exit;
                                        ...
                                        <tr style="color: black">
                                            ...
                                            <td class="cart-product-quantity">
                                                <div class="quant-input">
                                                    <div class="arrows">
                                                        ...
                                                        <button style="border: white; background-color: white "   name="submit" class="arrow minus gradient"><span   class="ir icon fa fa-sort-desc"></span></button>
                                                    </div>
                                            ...
                                            <td class="romove-item"><button  style="color:red;background-color: white; border: white; font-size: 50px" class="fa fa-trash" type="submit" name="remove_code[]" value="<?php echo htmlentities($row['id']);?>"></button></td>
                                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="cart-checkout-btn pull-right ">
                                    <button  style="background-color: #000000; font-size: 18px;border-radius: 5%;" type="submit" name="ordersubmit" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> IIBSO / BUY NOW</button>
                ...
                <div class="col-md-4 col-sm-12 estimate-ship-tax" style="color: black">
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                            <th>
